<?php $url = url()->current(); ?>{{-- // finds current url of sidebar clicked --}}
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li <?php if (preg_match("/dashboard/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/dashboard') }}"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>{{-- //preg_match checks if whether current url clicked of sidebar matches with main url(if it matches then that sidebar is main menu is opened and higlighted the clicked menu in sidebar) --}}
