    			...
    			<div class="panel-body">
    				<div class="table-responsive">
    					<table class="table table-condensed">
    						<thead>
                                <tr>
        							<td style="width:20%" class=""><strong>Product Code</strong></td>
        							{{-- <td class="text-center"><strong>Product Name/Code</strong></td> --}}
                            ...
                            @foreach($orderDetails->orders as $pro)
    							...
    							<tr>
                                    ...
                                    <td class="text-center">NRS{{$pro->product_price * $pro->product_qty}}</td>
                               ...
                               @endforeach
    							<tr>
    								...
    								<td class="thick-line text-right">Nrs{{$Subtotal}}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
                                    <td class="no-line"></td>
    								...
    								<td class="no-line text-right">NRS 0</td>
    							</tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    ...
                                    <td class="no-line text-right">NRS {{$orderDetails->coupon_amount}}</td>
                                </tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">NRS{{$orderDetails->grand_total}}</td>
    							</tr>
    						</tbody>
    					</table>
    				</div>
