            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td>{{$coupon->amount}}
                    @if($coupon->amount_type=="Percentage") % @else Nrs @endif
                  ...
                  <td class="center">
                    ...
                    <a id="delCoupon" rel="{{ $coupon->id }}" rel1="delete-coupon" href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Coupon">Delete</a>{{-- //delete-coupon is link to delete coupon which is defined in web.php for delete
                  --}}
                  </td> 
                </tr>
